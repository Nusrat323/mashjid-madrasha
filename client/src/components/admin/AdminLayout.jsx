    ...
    <div className="min-h-screen bg-slate-50">
      ...
      >
        ...
        <div className="space-y-1 border-t border-slate-100 p-4">
          <p className="truncate px-4 pb-2 text-sm text-slate-500">
            {user.email}
          </p>

          <Link
            to="/"
            className="flex items-center gap-3 rounded-xl px-4 py-2.5 text-slate-600 transition hover:bg-indigo-50"
          >
            <FaHome />
            সাইট দেখুন
          </Link>
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-slate-200 bg-white/90 px-4 backdrop-blur lg:hidden">
          ...
          <span className="font-display font-bold text-indigo-950">
            অ্যাডমিন প্যানেল
          </span>
        </header>
